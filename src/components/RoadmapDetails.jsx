      ...
      features: [
        {
          ...
          subFeatures: ["analysis of new launches based on onchain data,\ntwitter sentiment and provided code"]
        },
        {
          title: "Risk assessment",
          subFeatures: ["through repository/twitter/onchain analysis"]
        },
        {
          title: "Cross-platform Bot",
          subFeatures: ["Twitter integration, Telegram integration"]
        }
      ]
    },
    {
      title: "Deepen Social Signal Analysis",
      status: "Planned",
      timeline: "Q1 2025",
